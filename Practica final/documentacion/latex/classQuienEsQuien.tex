...
Añade un personaje del árbol ya creado. 


\begin{DoxyParams}{Parámetros}
{\em nombre} & Nombre del personaje a añadir. \\
\hline
{\em caracteristicas} & Atributos del personaje a añadir. \\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
Árbol ya creado con al menos dos personajes. 
\end{DoxyPrecond}
...
Elimina un personaje del árbol ya creado. 


\begin{DoxyParams}{Parámetros}
{\em nombre} & Nombre del personaje a eliminar. \\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
Árbol ya creado con al menos dos personajes. 
...
Muestras las preguntas ya formuladas para el nodo indicado. 


\begin{DoxyParams}{Parámetros}
{\em jugada} & Nodo del cual obtendremos las preguntas formuladas. \\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
jugada != N\+U\+LL. 
