...
private:
  ...
  vector_dinamico<string> v; /**< Vector dinámico que almacena los eventos. */
...
/**
  * @brief Devuelve un evento. Eficiencia: O(1).
  * @param i número del evento en la Fecha Historica. 0 <= i < num_eventos.
  * @return Referencia constante al evento ó NULL en caso de acceso incorrecto.
  */
