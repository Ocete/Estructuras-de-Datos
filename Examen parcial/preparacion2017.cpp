...
void UnionSinInterseccion(const set<int>& s1, const set<int>& s2, set<int>& result) {
  result.clear();
...
int main() {
  ...
  for (int i=0;i<=10;i++) {
   ...
   UnionSinInterseccion(c1, c2, res);
   cout << "Elementos de A ó B que no están en ambos conjuntos = "
        << res << endl;
